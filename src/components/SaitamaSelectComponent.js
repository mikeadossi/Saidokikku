  ...
  render() {
    return (
      <div className="saitama_select_container">
        <input className="saitama_option saitama_option_left" type="text" value="FILTERS"/>
        <input className="saitama_option saitama_option_center" type="text" value="CAMPAIGN"/>
